...
clear browser data;
experience a browser or device crash;
run out of available browser memory.

Download the finished PDF before leaving the editor if you want to keep your work.
...
downloads and cloud backups;
third-party hosting infrastructure;
the websites to which you later upload a completed document.

Keep your browser and operating system updated and use a trusted device when handling sensitive documents.

11. Whiteout is not redaction

The Whiteout tool only places a visual cover over existing PDF content.

It does not securely remove the underlying text, image, metadata, or document data. Covered information may remain recoverable or accessible through other tools.

Do not use Whiteout when permanent, secure redaction is required. Use a purpose-built redaction tool and verify the resulting document before sharing it.
...
Users are responsible for complying with laws and document-handling requirements that apply to them.
